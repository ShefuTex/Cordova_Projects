 ...
 var bcomServer = {
    ...
    switch (code) {
        ...
        if(bandera == 0){
            ...
            parent.loginDelegate.wtrealizaCompraVenta(params.data1, params.data2, params.data3, params.data4, params.data5, params.data6,"S", function () {
                console.log("sessionStorage.okCV: ",sessionStorage.okCV);
                if (sessionStorage.okCV == 'false'){
                    console.log("OKC = false");
                    self._operationCodeUnknown(params, callback);
                    console.log("Operacion Codigo desconocido");
                    bandera = 0;
                }else{
                    console.log("OKC = false");
    ...
    case this.operationCode.CancelacionOrdenCapitales:
        if(bandera == 0){
            ...
            parent.loginDelegate.wtcancelaOrden(params.data1, params.data2, params.data3,params.data4, function () {                                                console.log("LU_sessionStorage.okCO: ",sessionStorage.okCO);
                if(sessionStorage.okCO == 'false'){
                    console.log("LU_CANCELA_ERR_SERVER");
                    
                    self._operationCodeUnknown(params, callback);
                    bandera = 0;
                }else{
                    console.log("LU_CANCELA_OK_SERVER");
                    envioCancelar = 1;
                    envioCont = 0;
                    bandera = 0;
 ...
 _consultaCarteraDetalleInversion: function (params, callback) {
    ...
    if (sessionStorage.ok == 'true'){
        ...
        if (objJSON) {
            ...
            //console.log("LU_lstDetalle: ",lstDetalle);
            salida = lstDetalle;
        }
