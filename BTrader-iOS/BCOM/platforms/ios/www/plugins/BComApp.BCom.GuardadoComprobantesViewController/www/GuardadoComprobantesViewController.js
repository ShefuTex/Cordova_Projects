cordova.define("BComApp.BCom.GuardadoComprobantesViewController.GuardadoComprobantesDelegate", function(require, exports, module) {// __________ Inicia Phonegap __________
               ...
               console.log("FolderName: " + folderNm);
               var listComprobantes = readDirectory(folderNm, '.png', 'comprobante_');
               console.log("Lista Comprobantes: " + listComprobantes);
                    ...
                    if (listComprobantes != null){
                       ...
                       for (var i = 0; i < listComprobantes.length; i++) {
                           ...
                           if (listComprobantes[i].name != 'undefined'){
                               ...
                               if ( (itemName.indexOf("comprobante_") == 0) &&
                                   ( imageExists(path+"/"+itemName) == true)
                                   ){
               ...
               GuardadoComprobantesDelegate.prototype.savePDFWithNameAndFromUrl = function(localPdfName, pdfSourceUrl, directorio, successCallB, failCallB) {
               console.log("Entrando savePDFWithNameAndFromUrl");
              // var urlPdfWebtrader = "http://ifbdpsb.infobolsa.es/pdfs/EMISNET/2015/20150205/20150205165019FEB5_avisubmv_573307_1.pdf";
               exec(
                    successCallB,
                    failCallB,
                    "GuardadoComprobantesDelegate",
                    "savePDFWithNameAndFromUrl",
               ...
               GuardadoComprobantesDelegate.prototype.saveImageFromBase64 = function(localName, imageSource, directorio, successCallB, failCallB) {
               console.log("Entrando saveImageFromBase64");
               ...
               GuardadoComprobantesDelegate.prototype.recuperaComprobantesGua = function (folderName, successCallB, failCallB) {
                    console.log("Recuperando comprobantes- GuardadoComprobantesViesController.js");
               
                    exec(
                         function (listaComp) { successCallB(listaComp) },
                         function (mensaje) { failCallB(mensaje) },
                         "GeneraComprobantesDelegate",
                         "recuperaComprobantesGua",
                         [folderName]
                         );
               }
               
               GuardadoComprobantesDelegate.prototype.getFullPath = function (successCallB, failCallB) {
                    exec(
                         function (response) { successCallB(response)  },
                         function (erroResponse) { failCallB(mensaje)  },
                         "GeneraComprobantesDelegate",
                         "getFullPath",
                         []
                         );
...
function readDirectory(folderName, filterExtension, filterPrefix){
    ...
    console.log("local FS Persistr: " + LocalFileSystem);
