...
function selectAppropiateResolution() {
	...
	var anchoWidth = window.innerWidth;
	var altoHeight = window.innerHeight;
	var altura = screen.height;
	var ancho = screen.width;
	var altoAvai = screen.availHeight;
	var anchoiAvai = screen.availWidth;

	var viewport = { width : $(window).width(), height : $(window).height() };
	console.log("dimensiones con viewport  alto: "+viewport.height+"  "+"ancho: "+viewport.width);
	console.log("dimensiones con window  alto: "+altoHeight+"  "+"ancho: "+anchoWidth);
	console.log("dimensiones con screen  alto: "+altura+"  "+"ancho: "+ancho);
	console.log("dimensiones con Avail  alto: "+altoAvai+"  "+"ancho: "+anchoiAvai);
	
	//alert("dimensiones con viewport  alto: "+viewport.height+"  "+"ancho: "+viewport.width+"\n"+"dimensiones con window  alto: "+altoHeight+"  "+"ancho: "+anchoWidth+"\n"+"dimensiones con screen  alto: "+altura+"  "+"ancho: "+ancho+"\n"+"dimensiones con Avail  alto: "+altoAvai+"  "+"ancho: "+anchoiAvai);
	...
	currentHeight = (0 != window.innerHeight) ? window.innerHeight : window.parent.window.innerHeight;
		...
		//alert("ancho: "+minWidth+"\n"+"alto: "+currentHeight);
		

		
		if(viewport.width == anchoWidth ){
			if(currentWidth == 	ancho){
				var cambio = false;
			}
			else {
				var cambio = true;
    ...
    if (isIOS()) {
        ...
        if (currentHeight <= 601 && minWidth == 962 ) {
        	if(currentHeight <= 553){
             ...
             if (currentHeight <= 527){
                 filePath = 'css/1024x527.css';
                 console.log("1024x527");
                 needToReload = true;
             }else if(currentHeight <= 552){
                 filePath = 'css/1024x552.css';
                 console.log("1024x552");
                
                 needToReload = true;
             }else{
                 filePath = 'css/1024x600.css';
                 console.log("1024x600");
                 
                 needToReload = true; 
             }

        } else if (currentHeight <= 800 &&  minWidth == 1280) {
        	if(currentHeight <= 752){
                filePath = 'css/1280x752.css';
                console.log("1280x752");
        ...
        } else if (currentHeight <= 1200 && minWidth == 1920) {
            filePath = 'css/1920x1200.css';
            console.log("1920x1200");
           
            needToReload = true;
        } else if(currentHeight <=600 && minWidth == 960){
            filePath = 'css/960x527.css';
            console.log("960x527");
            ...
            needToReload = true;
            parent.loginDelegate.showAlert("Aviso\n","Lo sentimos la apliacón no está preparada para este dispositivo","Aceptar");
