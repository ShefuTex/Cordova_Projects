        ...
        exec(
            function (jsonResponse) {
                ...
                if (jsonResponse.indexOf("\"idInfobolsa\":\"\"") != -1) {
                    ...
                    //alert("Aviso\n Para ingresar a Bancomer Trader es necesario contratarlo previamente, contacta a tu ejecutivo.");
                   console.log("wtConsultaTipoServicio-TokenViewController.js");
                  parent.loginDelegate.showAlertInicio("Aviso\n","Para ingresar a Bancomer Trader es necesario contratarlo previamente, contacta a tu ejecutivo.","Aceptar");
    ...
    wtConsultaContratosPatrimoniales: function () {
        exec(
            function (jsonResponse) {
                ...
                //tokenViewController.goToPosicionGlobal();
